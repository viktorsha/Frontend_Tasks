...
export const About = () => {
    return(
        <div>
            <h1 className={"moto-text"}>IT'S TIME YOU MAKE YOUR LIFE NOTICEABLE</h1>
            <h3 className={"moto-description-text"}>Remember everything and tackle any project with your notes, tasks, and schedule all in one place.</h3>
            <div className={"main-container"}>
                <main>
                    <div className={"notes-app-picture"}>
                        <img src="https://evernote.com/c/assets/homepage-repackaging/task_hero_image@2x__en.png?465752cfb86f86f4" alt={"Main picture"}/>
                    </div>
